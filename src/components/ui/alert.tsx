...
const alertVariants = cva(
  "relative w-full rounded-lg border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-0.5 items-start has-[>svg]:[&>svg]:size-4 has-[>svg]:[&>svg]:translate-y-0.5 has-[>svg]:[&>svg]:text-current",
  {
    variants: {
      variant: {
